    ...
    <div class="sentinel">
      ...
      <div class="box" id="box">
       ...
       <div id="ftp" class="ftp">
        <form method="post" action="ftp_backup.py">
      ...
      <input type="text" id="fileName" name="fileName"class="login__input name" placeholder="File Name">
       ...
       <button type="submit" class="login__submit" id="serial_submit" name="submit" value="submit">Backup</button>
        </form>
       </div>    

     
      <div id="tftp" class="tftp">
      <form method="post" action="tftp_backup.py">
      ...
      <button type="submit" class="login__submit" id="ssh_submit" name="submit" value="submit">Backup</button>
      </form>
      </div>
